...
public class iranyitott_GUI extends javax.swing.JFrame {

    public iranyitott_GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Összesítő"));
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        try {
            List<String> adatok = Files.readAllLines(Paths.get("emberek.txt"));
        } catch (IOException ex) {
            Logger.getLogger(iranyitott_GUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(iranyitott_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new iranyitott_GUI().setVisible(true);
            }
        });
    }
